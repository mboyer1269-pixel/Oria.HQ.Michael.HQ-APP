...
-- See docs/MISSION_PERSISTENCE_SCHEMA_PROPOSAL.md and
--     docs/security/mission-persistence-migration-runbook.md (if present).
-- Intended final name at GO: db/migrations/0021_mission_execution_attempts.sql
--
...
-- migration only at GO. Additive and reversible; behavior-neutral until code is
-- wired to the new table (which stays behind an OFF-by-default flag).
