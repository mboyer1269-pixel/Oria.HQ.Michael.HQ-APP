-- 0021_mission_persistence_completion_verify.sql — READ-ONLY post-apply check.
-- Source: db/migrations/drafts/mission_persistence_completion_verify.sql
--
-- Run AFTER applying 0021_mission_persistence_completion.sql on STAGING.
