...
-- Source of truth: db/migrations/drafts/action_ledger_hash_chain_02_seal.sql
...
--
-- APPLY ONLY AFTER Phase 1 columns (0022) are live AND the TS writer has
-- backfilled every existing row (genesis + recompute). Reasons:
...
--
-- STAGING only; never prod (cpwerynafcszwagroeek) without a separate written GO.
