...
const NAV: NavItem[] = [
  ...
  { key: "sales", label: "Sales Desk", href: "/hq/sales", icon: Car, group: "Pilotage", tipTitle: "Sales Desk", tipDetail: "File du matin, kit Marketing multi-canal, capture leads — prepare-only." },
