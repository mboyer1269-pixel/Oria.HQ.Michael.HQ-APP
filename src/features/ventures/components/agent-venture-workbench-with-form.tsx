...
import { buildAgentRevenueValidationSprintPlans } from "../agent-revenue-validation-sprint";
...
import { VentureValidationSprintPanel } from "./venture-validation-sprint-panel";
...
export function AgentVentureWorkbenchWithForm() {
  ...
  const validationSprintPlans = buildAgentRevenueValidationSprintPlans(items);
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-[11px] text-neutral-500">
            Drafts a validation sprint from the current workbench items. Read-only. No execution
            authorized.
          </p>
        </div>
        <VentureValidationSprintPanel items={validationSprintPlans} />
      </div>
