  ...
  return (
    <CockpitShell active="sales" crumb="Sales Desk">
      <HqPageHeader
        ...
        description={
          <>
            Remplis ton livre de RDV → packs marketing / prospection → sync inventaire → fiches
            Marketplace → relances warm. Prepare-only : toi tu publies et tu envoies. Activix arrive
            lundi.
          </>
        }
      />
